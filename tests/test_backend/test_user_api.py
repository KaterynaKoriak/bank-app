...
def test_register_user(user_scenario):
    ...
    user_api_steps.get_user_info(test_params["firstly_created_user_customer_id"])
    user_api_assert_steps.check_user_data(test_params["firstly_created_user_customer_id"],
                                          user_scenario.user_data.customer)
...
def test_update_user_info(user_scenario):
    user_api_steps.update_customer_info(test_params["initialized_db_second_customer_id"],
                                        user_scenario.user_data.customer)
    user_api_assert_steps.check_user_data(test_params["initialized_db_second_customer_id"],
                                          user_scenario.user_data.customer)
...
def test_get_customer_accounts_info(user_scenario):
    user_api_steps.register_user(user_scenario.user_data)
    user_api_assert_steps.check_new_users_account(test_params["firstly_created_user_customer_id"])
